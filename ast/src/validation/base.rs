...
pub enum Error {
    ...
    TermIsPureButExpectedTypeIsNotCommandType { expected_type: Type },
...
impl Error {
    pub fn show(&self, sh: &Show) -> String {
        ...
        match self {
            ...
            TermIsPureButExpectedTypeIsNotCommandType { expected_type } => format!("Term is a pure(...), but its expected type is {}.", sh.show_type(expected_type)),
